                    ...
                    <div class="tab-pane" :class="active=='detail'?'active':''">
                                ...
                                <div class="card">
									...
									<div class="card-body">
                                       ...
                                       <div class="card-footer text-center">
                                        <div class="row">
											<button class="col-md-12 col-sm-12 col-12 btn btn-primary" @click.prevent="approve" v-if="current.role.name.toUpperCase() == 'ADMIN'&& borrower.user.status.toUpperCase() != 'ACTIVE'">
                                ...
                                <div class="card-header">
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <button class="nav-link" :class="tab=='thirdu'?'active':''" style="margin-right:10px"  @click.prevent="tab='third'" type="button" role="tab" >Transaction</button>
                                        </div>
                                    </nav>
                                </div>
                                   <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <template v-slot:item.stat="props">
                                   ...
                                   <span class="badge alert-success" v-if="props.item.status !='ACTIVE'&&props.item.stage == process.stage" title="Approve"><button @click.prevent="approveTrans(props.item)"><i class="fa-solid fa-check-double"></i></button></span>
        ...
        this.progress = ((result.stage-1)/this.processes.length)*100;
         ...
         const respo = await axios.get('../api/borrower-invoice/'+result.id);
            ...
            const res = await axios.get('api/transaction-user/'+result.user_id);
             ...
             const resut = await axios.get('api/flow-process/'+9+'/'+staff.data.role_id);

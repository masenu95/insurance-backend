            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><router-link to="../../admin-categories" class="nav-link active" >List View</router-link ></li>
                        <li class="nav-item"><router-link to="../../admin-category-create"  class="nav-link " >Add</router-link ></li>
...
export default {
    ...
    methods: {
        async filterData(){
            this.loading=true;
            const response = await axios.post('api/category-filter',this.filter);

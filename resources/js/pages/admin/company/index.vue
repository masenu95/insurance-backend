            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <div class="header-action">
                        <h1 class="page-title">Insurer</h1>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-6">
                                            <ul class="header-dropdown inline-button" style="float:right;">
                                                ...
                                                <li>
                                                   <button class="btn btn-info excel-green" type="button" @click="dialog=!dialog">New Insurer</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <template #item.index="{ item }">
                                    {{ all.indexOf(item) + 1 }}
                                     ...
                                     <template v-slot:item.img="props">
                                        <img :src="url+props.item.logo_url"  style="height: 50px;width: 50px;border-radius: 6px;" alt="" srcset="">
                                    </template>

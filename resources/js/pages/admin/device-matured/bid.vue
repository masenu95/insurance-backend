          ...
          <div class="section-body mt-4">
            <div class="container-fluid">
              <div class="tab-content">
                <button type="button" class="btn btn-primary" @click.prevent="disburseInvoice">TZS {{payBalance |formatNumber }} Pay </button>
              <br><br>
                  ...
                  <div class="card">
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <template v-slot:item.mon="props">
                            {{(parseInt(props.item.month)) | formatNumber}}
                        </template>

                        <template v-slot:item.prof="props">
                            {{(parseInt(props.item.profit_after_tax)) | formatNumber}}
                        </template>
...
this.companies = response.data;
          const res = await axios.get('api/device-matured-bid');
               this.bids = res.data;
               const resp = await axios.get('api/device-matured-amount');
               this.payBalance = resp.data;
      ...
      methods: {
          ...
          async disburseInvoice(){
            ...
            title: 'Are you sure you want to initiate month repayment of '+(this.payBalance),
            ...
            const response = await axios.post('../../../api/device-month-repay');
            ...
            this.$router.push('../../admin-device-bids');

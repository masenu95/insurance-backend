                            ...
                            <div class="table-responsive">
                                ...
                                class="elevation-1">
                                 ...
                                 <template v-slot:item.controls="props">
                                      <router-link type="button" :to="'../repay/'+props.item.id" class="btn btn-icon btn-sm" title="show"><i class="fe fe-maximize"></i></router-link>
...
export default {
    ...
    async beforeMount(){
        ...
        const res = await axios.get('api/device-bid-repay');

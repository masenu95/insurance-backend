                            ...
                            <div class="table-responsive">
                                ...
                                class="elevation-1">
                                 ...
                                 <template v-slot:item.controls="props">
                                      <router-link type="button" :to="'../disbursement/'+props.item.id" class="btn btn-icon btn-sm" title="show"><i class="fe fe-maximize"></i></router-link>
                                  ...
                                  <template v-slot:item.inStatus="props">
                                   ...
                                   <span class="badge alert-danger" v-else>{{props.item.invoice_status}}</span>
                                    ...
                                    <template v-slot:item.tradingfee="props">
                                      {{props.item.invoice.trading_fee}}%
                                    </template>

                                    <template v-slot:item.tradingfeeAmount="props">
                                        {{props.item.invoice.trading_fee_amount | formatNumber}}
                                    </template>
...
export default {
    ...
    async beforeMount(){
        ...
        const res = await axios.get('api/disbursement');

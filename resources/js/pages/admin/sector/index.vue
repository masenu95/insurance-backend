                            ...
                            <div class="table-responsive">
                                ...
                                >
                                 ...
                                 <template v-slot:item.controls="props">
                                      ...
                                      <router-link :to ="'../../sector-edit/'+props.item.id" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></router-link>
...
export default {
    ...
    methods: {
      ...
      var result = await this.$swal({
        ...
        if (result.isConfirmed) {
            try{
          var response = await axios.delete('../../api/sectors/'+id);
          if(response.status == 200){

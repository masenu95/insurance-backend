                                    ...
                                    <div class="table-responsive">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <ul class="header-dropdown" style="float: right">
                                                    <li>
                                                        <download-excel class="btn btn-info excel-green" :data="invoices"
                                                            :fields="label" title="export excel" worksheet="My Worksheet"
                                                            name="Invoices.xls" style="color: #fff"><i
                                        ...
                                        <v-data-table :headers="headers" :items="all" :items-per-page="10" :search="search"
                                            ...
                                            <template v-slot:item.stat="props">
                                                <span class="badge alert-success" v-if="props.item.status ==
                                                    'ACTIVE'
                                                    ">{{
        props.item.status
    }}</span>
                                                <span class="badge alert-success" v-else>{{
                                                    props.item.status
                                                }}</span>
                                            </template>
                                            <template v-slot:item.actn="props">
                                                ...
                                                <span class="badge alert-danger" title="cancel"><i @click.prevent="cancel(props.item)" class="fa-solid fa-ban"></i></span>
                                            </template>
                                        </v-data-table>
                                    </div>
                                </div>
